...
kk = LINETCR.LINE() #シェーレ
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #ブラート
kc.login(qr=True)
kc.loginResult()
...
"""
KAC=[cl,ki,kk,kc,ks]
#DEF1=[ki,kk,kc,ks,ka,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF2=[cl,kk,kc,ks,ka,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF3=[cl,ki,kc,ks,ka,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF4=[cl,ki,kk,ks,ka,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF5=[cl,ki,kk,kc,ka,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF6=[cl,ki,kk,kc,ks,kb,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF7=[cl,ki,kk,kc,ks,ka,ko,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF8=[cl,ki,kk,kc,ks,ka,kb,ke,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF9=[cl,ki,kk,kc,ks,ka,kb,ko,ku] What a useless?  (Piece of trash,better forgot it!)
#DEF10=[cl,ki,kk,kc,ks,ka,kb,ko,ke] What a useless?  (Piece of trash,better forgot it!)
mid = cl.getProfile().mid #タツミ
Amid = ki.getProfile().mid #アカメ
Bmid = kk.getProfile().mid #シェーレ
Cmid = kc.getProfile().mid #ブラート
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","NightRaid","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye NightRaid","Kabur all","Kaboor all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
